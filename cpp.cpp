// Program for creating a bill in a supermarket
#include<iostream>
#include<windows.h>
#include<conio.h>
#include<fstream>
...
// Structure to represent the date
struct date {
    int mm, dd, yy;
};
...
public:
    ...
    // Function to display item details for reporting
    void report() {
        gotoxy(3, k);
        cout << itemno;
        gotoxy(13, k);
    ...
    // Function to return item number
    int retno() {
        return itemno;
    }
};

// Amount class inheriting from item class
...
public:
    ...
    // Function to display amount details for reporting
    void report();
